...
def export_manual_pipetting(args):
    ...
    elif args.type == 'filling_out_array':
        clarity_epp.export.manual_pipetting.samplesheet_filling_out_array(lims, args.process_id, args.output_file)
    elif args.type == 'normalization_array':
        clarity_epp.export.manual_pipetting.samplesheet_normalization_array(lims, args.process_id, args.output_file)
    elif args.type == 'amplification_array':
        clarity_epp.export.manual_pipetting.samplesheet_amplification_array(lims, args.process_id, args.output_file)
...
if __name__ == "__main__":
    ...
    parser_export_manual_pipetting.add_argument(
        ...
        choices=[
            ...
            'pool_magnis_pools', 'filling_out_array', 'normalization_array', 'amplification_array'
        ],
