...
def export_illumina(args):
    ...
    clarity_epp.export.illumina.create_samplesheet(lims, args.process_id, args.output_file)
...
if __name__ == "__main__":
    ...
    parser_export_magnis = subparser_export.add_parser("magnis", help="Export magnis samplesheet", parents=[output_parser])
    ...
    parser_export_manual_pipetting.add_argument(
        ...
        choices=[
            "purify",
            "dilute_library_pool",
            "multiplex_library_pool",
            "multiplex_sequence_pool",
            "normalization",
            "capture",
            "exonuclease",
            "pcr_exonuclease",
    ...
    parser_export_sample_udf_dx.add_argument("-p", "--sequencing_run_project", nargs="?", help="Sequencing run project name")
