...
def normalise(lims, process_id, output_file):
    ...
    with open(output_file, 'w') as file:
        file.write('Monsternummer\tPlate_Id_input\tWell\tPlate_Id_output\tPipetteervolume DNA (ul)\tPipetteervolume H2O (ul)\n')
	...
	monsternummer = {}
        ...
        for well in utils.sort_96_well_plate(monsternummer.keys()):
            file.write('{monsternummer}\t{plate_id_input}\t{position}\t{plate_id_output}\t{volume_DNA}\t{volume_H2O}\n'.format(
